  ...
  gamePlay = (num1, num2) => {
    ...
    gameOver = () => {
      ...
      if (num1 == 19) {
        ...
        scoreDecider('Score1SubtractionEasy', 'Score2SubtractionEasy', 'Score3SubtractionEasy', 'Score4SubtractionEasy', 'Score5SubtractionEasy', gameScore);
        localStorage.removeItem('currentScore');
      } else if (num1 == 49) {
        localStorage.setItem('currentScore', gameScore);
        scoreDecider('Score1SubtractionMedium', 'Score2SubtractionMedium', 'Score3SubtractionMedium', 'Score4SubtractionMedium', 'Score5SubtractionMedium', gameScore);
        localStorage.removeItem('currentScore');
      } else if (num1 == 99) {
        localStorage.setItem('currentScore', gameScore);
        scoreDecider('Score1SubtractionHard', 'Score2SubtractionHard', 'Score3SubtractionHard', 'Score4SubtractionHard', 'Score5SubtractionHard', gameScore);
        localStorage.removeItem('currentScore');
      }
    };
  };
